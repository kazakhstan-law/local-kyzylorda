...
source: https://zan.gov.kz/client/#!/doc/114592/rus/24.08.2017
---
...
2. Основные термины и понятия, которые используются в настоящих Правилах:
   ...
   9) уполномоченная организация – Жалагашское районное отделение департамента “Межведомственный расчетный центр социальных выплат” - филиала некоммерческого акционерного общества “Государственная корпорация “Правительство для граждан” по Кызылординской области;
