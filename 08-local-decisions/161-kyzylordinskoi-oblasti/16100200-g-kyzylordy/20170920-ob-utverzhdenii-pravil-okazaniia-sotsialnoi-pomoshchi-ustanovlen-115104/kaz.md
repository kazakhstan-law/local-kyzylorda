...
caused_by:
  code: '115963'
  title: «Әлеуметтік көмек көрсету, оның мөлшерлерін белгілеу және мұқтаж азаматтардың жекелеген санаттарының тізбесін айқындау Қағидаларын бекіту туралы» Қызылорда қалалық мәслихатының 2017 жылғы 20 қыркүйектегі №106-16/4 шешіміне өзгеріс енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/115963/kaz
source: https://zan.gov.kz/client/#!/doc/115104/kaz/27.10.2017
---
...
2. Осы Қағидаларда пайдаланылатын негiзгi терминдер мен ұғымдар:
   ...
   8) уәкiлеттi орган – жергілікті бюджет есебінен қаржыландырылатын, әлеуметтік көмек көрсетуді жүзеге асыратын “Қызылорда қаласының жұмыспен қамту және әлеуметтік бағдарламалар бөлімі” коммуналдық мемлекеттік мекемесі;

   9) уәкiлеттi ұйым – “Азаматтарға арналған үкімет” мемлекеттік корпорациясы” коммерциялық емес акционерлік қоғамының Қызылорда облысы бойынша филиалы – “Әлеуметтік төлемдерді ведомствоаралық есептеу орталығы” департаменті;
