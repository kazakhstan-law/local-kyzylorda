---
version_id: '26660_262029'
act_code: '26660'
language: kaz
title: Қызылорда облысында құрылыс материалдары, бұйымдары мен құрастырмалары өнеркәсібін дамытудың 2006-2014 жылдарға арналған өңірлік бағдарламасын бекіту туралы
requisite: Қызылорда облыстық мәслихатының 2005 жылғы 20 желтоқсандағы № 241 шешімі. Қызылорда облысының Әділет департаментінде 2006 жылғы 27 желтоқсанда № 4144 болып тіркелді
form: РЕШ
type_codes:
- РЕШ
approved_by:
...
registry_number: '26660'
source: https://zan.gov.kz/client/#!/doc/26660/kaz
---
