---
version_id: '70200_693135'
act_code: '70200'
language: kaz
title: '"Облыстың (қаланың, ауданның) құрметті азаматы" атағын беру қағидаларын бекіту туралы'
requisite: Қызылорда облыстық мәслихатының 2012 жылғы 6 желтоқсандағы № 63 шешімі. Қызылорда облысының Әділет департаментінде 2013 жылы 11 қаңтарда № 4387 тіркелді
form: РЕШ
type_codes:
- РЕШ
approved_by:
...
caused_by:
  code: '195396'
  title: «Облыстың (қаланың, ауданның) құрметті азаматы» атағын беру қағидаларын бекіту туралы» Қызылорда облыстық мәслихатының 2012 жылғы 6 желтоқсандағы № 63 шешіміне өзгеріс енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/195396/kaz
source: https://zan.gov.kz/client/#!/doc/70200/kaz
---
...
**Қызылорда облыстық мәслихатының кезекті 12 сессиясының төрағасы**
...
10. Куәлік пен төсбелгі облыс (қала, аудан) әкімімен және (немесе) облыстық (қалалық, аудандық) мәслихаттың төрағасымен салтанатты жағдайда тапсырылады.

    > *Ескерту. 10-тармақ жаңа редакцияда - Қызылорда облыстық мәслихатының 29.03.2024 № 84 шешімімен (алғашқы ресми жарияланған күнінен кейін күнтізбелік он күн өткен соң қолданысқа енгізіледі).*
