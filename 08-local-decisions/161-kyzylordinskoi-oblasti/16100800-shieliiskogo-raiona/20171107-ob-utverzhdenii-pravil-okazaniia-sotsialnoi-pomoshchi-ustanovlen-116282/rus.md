...
source: https://zan.gov.kz/client/#!/doc/116282/rus/07.11.2017
---
...
2. Основные термины и понятия, которые используются в настоящих Правилах:
   ...
   9) уполномоченная организация – Шиелийское районное отделение департамента “Межведомственный расчетный центр социальных выплат” - филиала некоммерческого акционерного общества “Государственная корпорация “Правительство для граждан” по Кызылординской области;
