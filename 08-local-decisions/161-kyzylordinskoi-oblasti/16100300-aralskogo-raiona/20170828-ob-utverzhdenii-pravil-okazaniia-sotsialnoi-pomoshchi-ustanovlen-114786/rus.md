...
source: https://zan.gov.kz/client/#!/doc/114786/rus/28.08.2017
---
...
2. Основные термины и понятия, которые используются в настоящих Правилах:
   ...
   9) уполномоченная организация – Аральское районное отделение департамента “Межведомственный расчетный центр социальных выплат” - филиала некоммерческого акционерного общества “Государственная корпорация “Правительство для граждан” по Кызылординской области;
